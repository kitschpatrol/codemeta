...
describe('licenseToSpdx', () => {
	it('should convert MIT to SPDX URI', () => {
		expect(licenseToSpdx('MIT')).toBe('https://spdx.org/licenses/MIT')
	})

	it('should convert Apache-2.0 to SPDX URI', () => {
		expect(licenseToSpdx('Apache-2.0')).toBe('https://spdx.org/licenses/Apache-2.0')
	})

	it('should convert GPL-3.0+ to or-later', () => {
		expect(licenseToSpdx('GPL-3.0+')).toBe('https://spdx.org/licenses/GPL-3.0-or-later')
	})

	it('should normalize https to http for SPDX URIs', () => {
		expect(licenseToSpdx('https://spdx.org/licenses/MIT')).toBe('https://spdx.org/licenses/MIT')
	})
	...
	it('should resolve deprecated GPL-3.0 short form', () => {
		expect(licenseToSpdx('https://spdx.org/licenses/GPL-3.0')).toBe(
