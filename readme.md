...
If multiple aliases, priority for populating the associated `codemeta.json` goes to the key, then falls through to key aliases in the order shown above. (e.g. homepage takes priority over url.)
